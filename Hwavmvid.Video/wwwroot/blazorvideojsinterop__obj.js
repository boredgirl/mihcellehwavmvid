export function initblazorvideo(dotnetobjref, id1, id2, type, sourceType, framerate, videoBitsPerSecond, audioBitsPerSecond, videoSegmentsLength, audioDefaultDeviceId, microphoneDefaultDeviceId, webcamDefaultDeviceId) {
    ...
    var __obj = {
        ...
        blazorvideomap: function (dotnetobjref, id1, id2, type, sourceType, framerate, videoBitsPerSecond, audioBitsPerSecond, videoSegmentsLength, audioDefaultDeviceId, microphoneDefaultDeviceId, webcamDefaultDeviceId) {
            ...
            this.base64toblob = function (base64str) {
                ...
                var blob = new Blob([arraybuffer], { type: __selfblazorvideomap.videomimetypeobject.mimetyperemotelivestream });
                return blob;
            };
            this.throwerror = function (message) {

                dotnetobjref.invokeMethodAsync('OnError', id1, id2, message);
            };

            this.livestreams = [];
            this.getlivestream = function (id1, id2) {

                return __selfblazorvideomap.livestreams.find(item => item.id1 === id1 && item.id2 == id2);
            };
            this.addlivestream = function (obj) {

                var item = __selfblazorvideomap.getlivestream(obj.id1, obj.id2);
                if (item === undefined) {
            ...
            this.locallivestreamwebcams = function (audio, micro, video) {
                ...
                this.broadcastvideodata = function (sequence) {
                    ...
                    reader.onloadend = async function (event) {
                        ...
                        dotnetobjref.invokeMethodAsync('OnDataAvailable', dataURI, id1, id2);
                    };
            ...
            this.initlocallivestreamwebcams = function (audio, micro, video) {
                ...
                try {
                    ...
                    __selfblazorvideomap.getlivestream(id1, id2);
                    if (livestream === undefined) {

                        var livestream = new __selfblazorvideomap.locallivestreamwebcams(audio, micro, video);
            ...
            this.initdeviceslocallivestreamwebcams = async function () {
                ...
                try {
                    ...
                    var livestream = __selfblazorvideomap.getlivestream(id1, id2);
                    if (livestream !== undefined && livestream.item instanceof __selfblazorvideomap.locallivestreamwebcams) {
            ...
            this.closelocallivestreamwebcams = async function () {
                ...
                if (livestream !== undefined && livestream.item instanceof __selfblazorvideomap.locallivestreamwebcams) {
                    ...
                    __selfblazorvideomap.removelivestream(id1, id2);
                }
            };

            this.locallivestreamwebscreen = function () {
            ...
            this.initlocallivestreamwebscreen = function () {
                ...
                try {
                    ...
                    if (livestream === undefined) {
                        ...
                        var livestream = new __selfblazorvideomap.locallivestreamwebscreen();
                        var livestreamdicitem = {
            ...
            this.startvideolocallivestreamwebscreen = function () {
                ...
                try {
                    ...
                    var livestream = __selfblazorvideomap.getlivestream(id1, id2);
                    if (livestream !== undefined && livestream.item instanceof __selfblazorvideomap.locallivestreamwebscreen) {
            ...
            this.locallivestreamwebsource = function () {
            ...
            this.initlocallivestreamwebsource = function () {
                ...
                try {
                    ...
                    if (livestream === undefined) {
                        ...
                        var livestream = new __selfblazorvideomap.locallivestreamwebsource();
                        var livestreamdicitem = {
            ...
            this.startvideolocallivestreamwebsource = function () {
                ...
                try {
                    ...
                    var livestream = __selfblazorvideomap.getlivestream(id1, id2);
                    if (livestream !== undefined && livestream.item instanceof __selfblazorvideomap.locallivestreamwebsource) {
    ...
    return new __obj.blazorvideomap(dotnetobjref, id1, id2, type, sourceType, framerate, videoBitsPerSecond, audioBitsPerSecond, videoSegmentsLength, audioDefaultDeviceId, microphoneDefaultDeviceId, webcamDefaultDeviceId);
