export class livestreamitem {
    ...
    constructor(dotnetobjref, id1, id2, type, sourceType, framerate, videoBitsPerSecond, audioBitsPerSecond, videoSegmentsLength, audioDefaultDeviceId, microphoneDefaultDeviceId, webcamDefaultDeviceId) {
    ...
    dotnetobjref; id1; id2; type; sourceType; framerate;
    videoBitsPerSecond; audioBitsPerSecond; videoSegmentsLength;
    audioDefaultDeviceId; microphoneDefaultDeviceId; webcamDefaultDeviceId;

    locallivestreamwebcamselementidprefix = '#local-livestream-element-id-';
    remotelivestreamelementidprefix = '#remote-livestream-element-id-';
    microsourcelocalid = '#local-livestream-micro-source-';
    audiosourcelocalid = '#local-livestream-audio-source-';
    videosourcelocalid = '#local-livestream-video-source-';
    videosourceurllocalidprefix = '#local-livestream-video-source-url-';
    ...
    livestreams = [];
    getlivestream = function (itemid1, itemid2) {
    ...
    removelivestream = function (itemid1, itemid2) {

        //this.livestreams = this.livestreams.filter(item => item.id !== roomId);
        var livestream = this.getlivestream(itemid1, itemid2);
...
export class locallivestreamwebcamitem extends livestreamitem {

    constructor(dotnetobjref, id1, id2, type, sourceType, framerate, videoBitsPerSecond, audioBitsPerSecond, videoSegmentsLength, audioDefaultDeviceId, microphoneDefaultDeviceId, webcamDefaultDeviceId) {

        super(dotnetobjref, id1, id2, type, sourceType, framerate, videoBitsPerSecond, audioBitsPerSecond, videoSegmentsLength, audioDefaultDeviceId, microphoneDefaultDeviceId, webcamDefaultDeviceId);
    }

    locallivestreamwebcams = function (__selfblazorvideomap, audio, micro, video) {
        ...
        this.videoelementid = __selfblazorvideomap.locallivestreamwebcamselementidprefix + __selfblazorvideomap.id1 + __selfblazorvideomap.id2;
        this.getvideoelement = function () {
            return document.querySelector(__selflocallivestreamwebcams.videoelementid);
        };

        this.microsourcelocalid = __selfblazorvideomap.microsourcelocalid + __selfblazorvideomap.id1 + __selfblazorvideomap.id2;
        this.getmicrosourcelocaldomelement = function () {
            return document.querySelector(__selflocallivestreamwebcams.microsourcelocalid);
        };
        this.audiosourcelocalid = __selfblazorvideomap.audiosourcelocalid + __selfblazorvideomap.id1 + __selfblazorvideomap.id2;
        this.getaudiosourcelocaldomelement = function () {
            return document.querySelector(__selflocallivestreamwebcams.audiosourcelocalid);
        };
        this.videosourcelocalid = __selfblazorvideomap.videosourcelocalid + __selfblazorvideomap.id1 + __selfblazorvideomap.id2;
        ...
        this.gotDevices = function (mediadeviceinfos) {
            ...
            __selflocallivestreamwebcams.audioselect.value = audio ?? __selfblazorvideomap.audioDefaultDeviceId ?? __selflocallivestreamwebcams.audioselect.value;
            __selflocallivestreamwebcams.microselect.value = micro ?? __selfblazorvideomap.microphoneDefaultDeviceId ?? __selflocallivestreamwebcams.microselect.value;
            __selflocallivestreamwebcams.videoselect.value = video ?? __selfblazorvideomap.webcamDefaultDeviceId ?? __selflocallivestreamwebcams.videoselect.value;
        };
        ...
        this.getStream = function (audiochanged, microchanged, videochanged) {
            ...
            var audioDeviceIdConstraintValue = audiochanged ?? audio ?? __selfblazorvideomap.audioDefaultDeviceId ?? __selflocallivestreamwebcams.audioselect.value;
            var microDeviceIdConstraintValue = microchanged ?? micro ?? __selfblazorvideomap.microphoneDefaultDeviceId ?? __selflocallivestreamwebcams.microselect.value;
            var videoDeviceIdConstraintValue = videochanged ?? video ?? __selfblazorvideomap.webcamDefaultDeviceId ?? __selflocallivestreamwebcams.videoselect.value;
            ...
            window.navigator.mediaDevices
                ...
                .then(function (mediastream) {
                    ...
                    __selfgetstream.options = { mimeType: __selfblazorvideomap.videomimetypeobject.mimetypelocallivestream, audioBitsPerSecond: __selfblazorvideomap.audioBitsPerSecond, videoBitsPerSecond: __selfblazorvideomap.videoBitsPerSecond, ignoreMutedMedia: true };
        ...
        this.handleonchangeevent = async function () {
            ...
            __selfblazorvideomap.dotnetobjref.invokeMethodAsync('OnUpdateDevices', __selfblazorvideomap.id1, __selfblazorvideomap.id2, __selflocallivestreamwebcams.audioselect.value, __selflocallivestreamwebcams.microselect.value, __selflocallivestreamwebcams.videoselect.value);
        ...
        this.pauselivestreamtask = function () {
            ...
            __selfblazorvideomap.dotnetobjref.invokeMethodAsync('PauseLivestreamTask', __selfblazorvideomap.id1, __selfblazorvideomap.id2);
        };
    ...
    initlocallivestreamwebcams = function (audio, micro, video) {
    ...
    initdeviceslocallivestreamwebcams = async function () {
    ...
    startbroadcastinglocallivestreamwebcams = async function () {
    ...
    startsequencelocallivestreamwebcams = function () {
    ...
    stopsequencelocallivestreamwebcams = function () {
    ...
    takesnapshotlocallivestreamwebcams = function () {
    ...
    closelocallivestreamwebcams = async function () {
...
export class locallivestreamwebsourceitem extends livestreamitem {
    ...
    locallivestreamwebsource = function (__selfblazorvideomap) {
        ...
        this.videosourceurllocalid = __selfblazorvideomap.videosourceurllocalidprefix + __selfblazorvideomap.id1 + __selfblazorvideomap.id2;
                ...
                fetch(url, { method: 'GET', mode: 'cors', referrerPolicy: 'no-referrer' })
                    ...
                    .then(url => {
                        ...
                        __selflocallivestreamwebsource.vElement.addEventListener('canplay', function (e) {
                            ...
                            __selfwebsourcestream.options = { mimeType: __selfblazorvideomap.videomimetypeobject.mimetypelocallivestream, audioBitsPerSecond: __selfblazorvideomap.audioBitsPerSecond, videoBitsPerSecond: __selfblazorvideomap.videoBitsPerSecond, ignoreMutedMedia: true };
    ...
    initlocallivestreamwebsource = function () {
    ...
    startvideolocallivestreamwebsource = function () {
    ...
    startsequencelocallivestreamwebsource = function () {
    ...
    stopsequencelocallivestreamwebsource = function () {
    ...
    takesnapshotlocallivestreamwebsource = function () {
    ...
    closelocallivestreamwebsource = async function () {
...
export class locallivestreamwebscreenitem extends livestreamitem {
    ...
    locallivestreamwebscreen = function (__selfblazorvideomap) {
        ...
        this.webscreenstream = function () {
            ...
            window.navigator.mediaDevices.getDisplayMedia(this.constrains)
                .then(function (mediastream) {
                    ...
                    __selfwebscreenstream.options = { mimeType: __selfblazorvideomap.videomimetypeobject.mimetypelocallivestream, audioBitsPerSecond: __selfblazorvideomap.audioBitsPerSecond, videoBitsPerSecond: __selfblazorvideomap.videoBitsPerSecond, ignoreMutedMedia: true };
    ...
    initlocallivestreamwebscreen = function () {
    ...
    startvideolocallivestreamwebscreen = function () {
    ...
    startsequencelocallivestreamwebscreen = function () {
    ...
    stopsequencelocallivestreamwebscreen = function () {
    ...
    takesnapshotlocallivestreamwebscreen = function () {
    ...
    closelocallivestreamwebscreen = async function () {
...
export class remotelivestreamitem extends livestreamitem {
    ...
    remotelivestream = function (__selfblazorvideomap) {

        var __selfremotelivestream = this;

        this.videoelementid = __selfblazorvideomap.remotelivestreamelementidprefix + __selfblazorvideomap.id1 + __selfblazorvideomap.id2;
        this.getvideoelement = function () {
    ...
    initremotelivestream = function () {
        ...
        try {
            ...
            if (livestream === undefined) {
                ...
                var livestream = new this.remotelivestream(this);
                var livestreamdicitem = {
    ...
    appendbufferremotelivestream = function (base64str) {
    ...
    takesnapshotremotelivestream = function () {
    ...
    closeremotelivestream = async function () {
