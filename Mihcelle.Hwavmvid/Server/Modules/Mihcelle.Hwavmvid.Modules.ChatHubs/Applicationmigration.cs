    ...
    public class Applicationmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationbuilder)
        {
            ...
            migrationbuilder.CreateTable(
                 ...
                 constraints: dbtable =>
                 {
                     dbtable.PrimaryKey("pk_application_chathubsid", item => item.Id);
                     dbtable.ForeignKey("fk_application_chathubs_moduleid", item => item.Moduleid, "Applicationmodules", "Id");
                 });
        }
